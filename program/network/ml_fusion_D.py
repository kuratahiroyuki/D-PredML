...
if __name__ == '__main__':
    ...
    machine_method=['RF','XGB','SVM','LGBM', 'NB', 'KN'] 
    encode_method=["RCKmer", "DNC", "TNC", "ENAC", "binary", "CKSNAP", "NCP", "ANF", "EIIP","PseEIIP", "W2V"]   
      
    combination = []
    combination.append(['LGBM','EIIP'])
    combination.append(['LGBM','ENAC'])
    combination.append(['LGBM','W2V'])
